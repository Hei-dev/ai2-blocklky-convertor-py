...
Blockly.Blocks.component_method = {
  ...
  getParamBlocklyType : function(param) {
    ...
    var blocklyType = Blockly.Blocks.Utilities.YailTypeToBlocklyType(param.type, Blockly.Blocks.Utilities.INPUT);
    if (blocklyType) {
  ...
  getReturnBlocklyType : function(methodObj) {
    var check = [];
    var blocklyType = Blockly.Blocks.Utilities.YailTypeToBlocklyType(methodObj.returnType, Blockly.Blocks.Utilities.OUTPUT);
    if (blocklyType) {
      if (Array.isArray(blocklyType)) {
        // Clone array.
        check = blocklyType.slice();
